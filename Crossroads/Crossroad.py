...
class Crossroad:
    ...
    def __init__(self):
        ...
        self.lights["A2"].constraints = ["AB1", "B1", "C1", "C2", "C3", "D1", "D2", "EV2", 
                                    "EV4", "E1",  "GV1", "GV3", "GF1", "GF2"] #oke
        self.lights["A3"].constraints = ["AB1", "B1", "C1", "C2", "C3", "D1", "D2", "EV2", 
                                    "EV4", "E1", "GV1", "GV3", "GF1", "GF2"] #oke 
        self.lights["A4"].constraints = ["AB1", "AB2", "B1", "D2", "GV1", "GV3", "GF1", "GF2"]  #oke
        self.lights["AB1"].constraints = ["A2", "A3", "A4", "B1", "C1", "C2", "C3", "D1", "D2", 
                                        "EV2", "EV4", "E1",  "GV1", "GV3", "GF1", "GF2"] #oke
        self.lights["AB2"].constraints = ["A4", "B1", "D2", "GV1", "GV3", "GF1", "GF2"] #oke
        self.lights["B1"].constraints = ["A2", "A3", "A4", "AB1", "AB2", "C1", "C2", "D1", 
                                    "D2", "EV1", "EV3", "E1"] #oke
        self.lights["B2"].constraints = ["A1", "C1", "C2", "D1", "D2", "D3", "EV1", "EV3", 
                                    "E1",  "GV2", "GV4", "GF1", "GF2"] #oke
        self.lights["B3"].constraints = ["A1", "C1", "C2", "D1", "D2", "D3", "EV1", "EV3", 
                                    "E1",  "GV2", "GV4", "GF1", "GF2"] #oke
        self.lights["B4"].constraints = ["A1", "B5", "BB1", "C2", "EV1", "EV3", "E1",  
                                    "FV2", "FV4", "FF1", "FF2"] #oke
        self.lights["B5"].constraints = ["B4", "C2", "A1"] #oke
        self.lights["BB1"].constraints = ["A1", "B4", "C2", "D1", "D2", "D3", "EV1", "EV3", 
                                    "E1",  "GV2", "GV4", "GF1", "GF2"] #oke
        self.lights["C1"].constraints = ["A1", "A2", "A3", "AB1", "B1", "B2", "B3", "D2", 
                                    "D3", "GV2", "GV4", "GF1", "GF2"] #oke
        self.lights["C2"].constraints = ["A1", "A2", "A3", "AB1", "B1", "B2", "B3", "B4", 
                                    "B5", "BB1", "D1", "FV2", "FV4", "FF1", "FF2"] #oke
        self.lights["C3"].constraints = ["A2", "A3", "AB1", "D1", "EV2", "EV4", "E1"] #oke
        self.lights["D1"].constraints = ["A1", "A2", "A3", "AB1", "B1", "B2", "B3", "BB1", 
                                    "C2", "C3", "EV2", "EV4", "E1",  "FV1", "FV3", 
                                    "FF1", "FF2"] #oke
        self.lights["D2"].constraints = ["A1", "A2", "A3", "A4", "AB1", "AB2", "B1", "B2", "B3", "BB1", 
                                    "C1","FV1", "FV3", "FF1", "FF2"]  #dit klopt nu                                  
        #self.lights["D2"].constraints = ["A1", "A2", "A3", "AB1", "AB2", "B1", "B2", "B3", "BB1", "C1", "EV2", "EV4", "E1",  "FV1", "FV3", "FF1", "FF2"] 
        self.lights["D3"].constraints = ["B2", "B3", "BB1", "C1", "FV1", "FV3", "FF1", "FF2", 
                                    "GV2", "GV4", "GF1", "GF2"] #oke
        self.lights["EV1"].constraints = ["B1", "B2", "B3", "B4", "BB1"] #oke
        self.lights["EV2"].constraints = ["A2", "A3", "AB1", "C3", "D1"] #oke
        self.lights["EV3"].constraints = ["B1", "B2", "B3", "B4", "BB1"] #oke
        self.lights["EV4"].constraints = ["A2", "A3", "AB1", "C3", "D1"] #oke
        self.lights["E1"].constraints = ["A2", "A3", "AB1", "B1", "B2", "B3", "B4", "BB1", "C3", "D1"] #oke
        self.lights["FV1"].constraints = ["D1", "D2", "D3"] #oke
        self.lights["FV2"].constraints = ["A1", "B4", "C2"] #oke
        self.lights["FV3"].constraints = ["D1", "D2", "D3"] #oke
        self.lights["FV4"].constraints = ["A1", "B4", "C2"] #oke 
        self.lights["FF1"].constraints = ["A1", "B4", "C2", "D1", "D2", "D3"] #oke
        self.lights["FF2"].constraints = ["A1", "B4", "C2", "D1", "D2", "D3"] #oke
        self.lights["GV1"].constraints = ["A1", "A2", "A3", "A4", "AB1", "AB2"] #oke
        #self.lights["GV2"].constraints = ["B3", "BB1", "C1", "D3"] 
        self.lights["GV2"].constraints = ["B2","B3","BB1", "C1", "D3"] #dit klopt nu
        self.lights["GV3"].constraints = ["A1", "A2", "A3", "A4", "AB1", "AB2"] #oke 
        self.lights["GV4"].constraints = ["B2","B3","BB1", "C1", "D3"] #dit klopt nu
        self.lights["GF1"].constraints = ["A1", "A2", "A3", "A4", "AB1", "AB2", "B2", "B3", "BB1", "C1", "D3"] #oke
        self.lights["GF2"].constraints = ["A1", "A2", "A3", "A4", "AB1", "AB2", "B2", "B3", "BB1", "C1", "D3"] #oke
